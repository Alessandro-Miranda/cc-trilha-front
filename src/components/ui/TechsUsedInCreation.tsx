...
function TechUsedLink({ children, link }: TechLinkProps) {
  return (
    <a
      href={link}
      target="_blank"
      rel="noreferrer"
      className="flex flex-col items-center text-red font-bold text-xs lg:text-base w-1/5"
    >
      {children}
    </a>
  );
    ...
    <div className="mt-5 lg:mt-10 flex flex-wrap lg:flex-nowrap justify-between gap-5 text-center">
      <TechUsedLink link="https://vitejs.dev/">
        <svg
          ...
          className="w-5 lg:w-10 fill-red"
        >
          <title>Vite</title>
      ...
      <TechUsedLink link="https://react.dev/">
        <svg
          role="img"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <TechUsedLink link="https://www.framer.com/motion/">
        <svg
          role="img"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <TechUsedLink link="https://tailwindcss.com/">
        <svg
          role="img"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <TechUsedLink link="https://fonts.google.com/">
        <svg
          role="img"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
